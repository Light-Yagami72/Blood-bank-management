...
public class ViewBDD extends JFrame  implements ActionListener{
	 ...
	 */
	public ViewBDD() {
		setTitle("BLOOD DONATE DETAILS");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ViewBDD.class.getResource("/com/images/blood-156063__340.png")));
	...
	public void  populateArray()
	{
		try {
			int rowcnt=0;
			String strcount="select count(*) from blooddonatedetails";
		...
		String strsql="select * from blooddonatedetails where PhoneNo=? ";
